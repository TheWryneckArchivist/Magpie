...
Given the wide adoption of better data interchange formats out there, it is intended for my use. I have been manually writing a language translator for parsing my custom configuration file, having started its primitive version back in the early March of 2025. Unfortunately, the partial write up of its earliest version was too tedious to handle, so I opted for another solution.
